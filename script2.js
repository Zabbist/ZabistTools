...
function copyNegativeToClipboard(){
  const text = "ugly, tiling, poorly drawn hands, poorly drawn feet, poorly drawn face, out of frame, extra limbs, disfigured, deformed, body out of frame, blurry, bad anatomy, blurred, watermark, grainy, signature, cut off, draft, duplicate, coppy, multi, two faces, two, disfigured, kitsch, ugly, oversaturated, grain, low-res";
